...
$user = array(
		...
		'uid' => '88895433', //这里填写你的UID信息,用户授权UID，在 http://user.seakee.cn 平台可以查看

		'token' => 'fc914cc2a516586f44109af75afc8719', //这里填写你的用户密匙信息,用户授权TOKEN，在 http://user.seakee.cn 平台可以查看

		'path' => '/jiexi', //一般不用修改,除非你放置在其他目录，修改格式 '/jiexi' (修改二级目录一定看好格式)，如果放在根目录就请留空，格式：'path' => '' 

		'domain' => 'tlkj.vip', //请设置您的解析域名（放解析客户端的域名），防止客户端被二开盗用数据（注意：此处不要添加 http:// 或 https://）
		
		'tiaodomain' => 'https://www.tlkj.vip', //请设置客户端被二开盗用后跳转的域名地址，被盗用后直接跳转到您设置的地址。
		
		'hdd' => '4', //视频默认清晰度，1标清，2高清，3超清，如果没有高清会自动下降一级（请保持默认，无需修改）
		...
		'ather' => 'https://www.8090g.cn/beiyongjx/?url=', //已为大家设置好备用接口,无特殊要求可以不用更改,如果不需要删除即可.//填写实例：'ather' => 'https://www.8090g.cn/?url=',

		'dplayer' => 'TLKJ解析', //用户设置dplayer播放器右键,不设置请留空。填写实例:'dplayer' => '8090解析,https://www.8090.la'
		
		'title' => 'TLKJ解析', //设置解析页面title名称   例如：'title' => '8090视频解析',
        ...
        'ckfont' => 'TLKJ解析', //ckplayer播放器设置控制栏上方漂浮字体，不需要请留空
        
        'ckhref' => 'https://www.tlkj.vip', //ckplayer播放器设置控制栏上方漂浮字体的点击跳转地址,需设置ckfont参数后才生效，不需要请留空

		'skin' => '4', //ckplayer播放器样式共4种,修改参数后更换播放器样式. 参数说明：1,2,3,4

		'hand' => 'TLKJ解析', //ckplayer播放器右键,例如:'hand'=>'8090解析,https://www.8090.la'
