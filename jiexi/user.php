...
$user = array(
		...
		'domain' => 'v.tlkj.vip', //请设置您的解析域名（放解析客户端的域名），防止客户端被二开盗用数据（注意：此处不要添加 http:// 或 https://）
		
		'tiaodomain' => 'https://v.tlkj.vip', //请设置客户端被二开盗用后跳转的域名地址，被盗用后直接跳转到您设置的地址。
        ...
        'ckhref' => 'https://v.tlkj.vip', //ckplayer播放器设置控制栏上方漂浮字体的点击跳转地址,需设置ckfont参数后才生效，不需要请留空
